...
import {
  ...
  GridStatusOption,
  VendorGridSetup,
  VendorGridSetupService,
} from '../../../services/vendor-grid-setup.service';

@Component({
  selector: 'app-vendor-grid-setup',
  standalone: true,
  imports: [FormsModule, RouterLink, ConfirmDialogComponent],
  templateUrl: './vendor-grid-setup.component.html',
  styleUrl: './vendor-grid-setup.component.scss',
})
export class VendorGridSetupComponent implements OnInit {
  private readonly service = inject(VendorGridSetupService);
  ...
  private applyPayload(p: VendorGridSetup): void {
